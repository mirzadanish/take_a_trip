...
function HeaderLogined({ placeholder }) {
        ...
        <div className="flex rounded-full items-center space-x-2 h-8 md:shadow-sm bg-white">
          <Menu>
            ...
            <MenuList className="sticky mt-3 rounded-md top-0 space-y-3 cursor-pointer bg-white pt-2 pb-2 z-50 outline-none">
              <MenuItem className="hover:font-semibold pl-3 pb-2 font-[Poppins] pt-2 pr-20 text-secondary hover:bg-primary hover:text-white active:scale-90 transition duration-150" onSelect={myAccount}>My Account</MenuItem>
              <MenuItem className="hover:font-semibold pl-3 pb-2 font-[Poppins] pt-2 pr-20 text-secondary hover:bg-primary hover:text-white active:scale-90 transition duration-150" onSelect={MyPI}>My Personal Info</MenuItem>
